...
const Travel: React.FC = () => {
  ...
  const tabs: { key: Tab; label: string; icon: React.ElementType; gradient: string }[] = [
    { key: "history", label: "Trips", icon: History, gradient: "bg-gradient-brand" },
    { key: "bookings", label: "Bookings", icon: Plane, gradient: "bg-gradient-brand" },
    { key: "flights", label: "Flights", icon: Search, gradient: "bg-gradient-brand" },
    { key: "hotels", label: "Hotels", icon: Hotel, gradient: "bg-gradient-brand" },
    { key: "pass", label: "Pass", icon: QrCode, gradient: "bg-gradient-brand" },
  ];
                ...
                <GlassCard className="cursor-pointer touch-bounce">
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-2">
                      <div className="w-8 h-8 rounded-lg bg-gradient-brand flex items-center justify-center shadow-depth-sm">
              ...
              <GlassCard className={cn("overflow-hidden p-0 cursor-pointer touch-bounce", !h.available && "opacity-50")} depth="md">
                <div className="relative">
                  ...
                  <div className="absolute top-3 right-3 flex items-center gap-1 px-2 py-1 rounded-full glass border border-border/30">
                    <Star className="w-3 h-3 text-warning" /><span className="text-xs font-bold text-foreground">{h.rating}</span>
                  </div>
                </div>
                <div className="p-4">
                  ...
                  <div className="flex items-center justify-between mt-3">
                    ...
                    {h.available ? (
                      <button className="px-4 py-2 rounded-xl bg-gradient-brand text-primary-foreground text-xs font-semibold active:scale-95 transition-transform min-h-[36px] shadow-glow-sm btn-ripple">Book Now</button>
