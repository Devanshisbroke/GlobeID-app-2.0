              ...
              child: Column(
                children: [
                  ...
                  _SettingsRow(
                    ...
                    onTap: () => context.push('/os2/copilot'),
                  ),
                  _SettingsRow(
                    icon: Icons.tune_rounded,
                    tone: const Color(0xFFD4AF37),
                    ...
                    onTap: () => context.push('/os2/settings'),
                  ),
                  _SettingsRow(
                    icon: Icons.lock_outline_rounded,
                    tone: const Color(0xFFE9C75D),
                    label: 'OS2 · Lock screen preview',
                    sub: 'Cinematic lock surface',
                    onTap: () => context.push('/os2/lock'),
                  ),
                  _SettingsRow(
                    icon: Icons.rocket_launch_rounded,
                    tone: const Color(0xFFD4AF37),
                    label: 'OS2 · Onboarding preview',
                    sub: 'Cinematic onboarding surface',
                    onTap: () => context.push('/os2/onboarding'),
                  ),
                  _SettingsRow(
                    icon: Icons.public_rounded,
                    tone: const Color(0xFFE9C75D),
                    label: 'Nexus · Travel OS',
                    sub: 'Canonical travel-OS surface',
                    onTap: () => context.push('/nexus/os'),
                  ),
                  _SettingsRow(
                    icon: Icons.account_balance_wallet_rounded,
                    tone: const Color(0xFFD4AF37),
                    label: 'Nexus · Wallet',
                    sub: 'Canonical wallet surface',
                    onTap: () => context.push('/nexus/wallet'),
                  ),
                  _SettingsRow(
                    icon: Icons.contact_page_rounded,
                    tone: const Color(0xFFE9C75D),
                    label: 'Nexus · Passport',
                    sub: 'Canonical passport surface',
                    onTap: () => context.push('/nexus/passport'),
                  ),
                  _SettingsRow(
                    icon: Icons.lock_outline_rounded,
                    tone: const Color(0xFFD4AF37),
                  ...
                  _SettingsRow(
                    ...
                    onTap: () => context.push('/bible/arrival'),
                  ),
                  _SettingsRow(
                    ...
                    onTap: () => context.push('/bible/lounge'),
                  ),
                  _SettingsRow(
                    icon: Icons.movie_filter_rounded,
                    tone: const Color(0xFFD4AF37),
                    label: 'Cinematics Hub',
                    sub: 'Ceremonies · transitions · briefs',
                    onTap: () => context.push('/cinematics'),
                  ),
                  _SettingsRow(
