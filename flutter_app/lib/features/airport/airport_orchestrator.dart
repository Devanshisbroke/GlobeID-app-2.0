    ...
    return PageScaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          CinematicReveal(
            ...
            child: Stack(
              children: [
                BoardingGateClock(
                  gate: _gate,
                  boardingTime: DateTime.now().add(const Duration(minutes: 28)),
                ),
                Positioned(
          ...
          AnimatedAppearance(
            ...
            child: const AirportJourneyStrip(
              ...
              stages: [
                ...
                AirportStage(
                    id: 'arrival', title: 'Arrival', icon: Icons.flag_rounded),
              ],
            ),
          ),
          ...
          // ── Live gate card ─────────────────────────────────
          AnimatedAppearance(
              child: _GateHero(gate: _gate, pulse: _pulse, walkMin: _walkMin)),
          const SizedBox(height: AppTokens.space4),
          ...
          // ── Terminal map ────────────────────────────────────
          AnimatedAppearance(
              delay: const Duration(milliseconds: 140), child: _TerminalMap()),
          const SizedBox(height: AppTokens.space4),
          ...
          // ── Lounge status ──────────────────────────────────
          AnimatedAppearance(
              delay: const Duration(milliseconds: 260), child: _LoungeStatus()),
          const SizedBox(height: AppTokens.space4),

          // ── Quick actions ──────────────────────────────────
          AnimatedAppearance(
              delay: const Duration(milliseconds: 320), child: _QuickActions()),
        ],
      ),
    );
  }
...
class _GateHero extends StatelessWidget {
  const _GateHero(
      {required this.gate, required this.pulse, required this.walkMin});
  final String gate;
              ...
              builder: (_, __) => Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      boxShadow: [
                        BoxShadow(
                            color: const Color(0xFF22C55E)
                                .withValues(alpha: 0.3 * pulse.value),
                            blurRadius: 8)
                      ],
                    ),
                  )),
          const SizedBox(width: 8),
          Text('LIVE GATE ASSIGNMENT',
...
class _TerminalPainter extends CustomPainter {
  ...
  @override
  bool shouldRepaint(covariant _TerminalPainter old) => false;
}
