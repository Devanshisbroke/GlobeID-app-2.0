              ...
              child: Column(
                children: [
                  ...
                  _CredentialSlab(
                    ...
                    title: 'Canonical bearer page',
                    sub: 'Issuer chain \u00b7 stamps \u00b7 attestations',
                    tone: Os2.identityTone,
                    onTap: () =>
                        GoRouter.of(context).push('/nexus/passport'),
                  ),
                  const SizedBox(height: Os2.space3),
                  _CredentialSlab(
                    icon: Icons.auto_stories_rounded,
                    label: 'BIBLE PASSPORT',
                    title: 'Liquid-glass passport spread',
                    sub: 'Cinematic bearer surface',
                    tone: Os2.identityTone,
                    onTap: () => GoRouter.of(context).push('/bible/passport'),
                  ),
                ],
              ),
            ),
