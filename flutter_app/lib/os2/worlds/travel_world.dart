              ...
              child: Row(
                children: [
                  ...
                  _StageChip(
                    ...
                    label: 'Arrival',
                    onTap: () => GoRouter.of(context).push('/arrival-live'),
                  ),
                  const SizedBox(width: 8),
                  _StageChip(
                    icon: Icons.assignment_returned_rounded,
                    label: 'Customs',
                    onTap: () => GoRouter.of(context).push('/customs'),
                  ),
                  const SizedBox(width: 8),
                  _StageChip(
                    icon: Icons.qr_code_scanner_rounded,
                    label: 'Kiosk',
                    onTap: () => GoRouter.of(context).push('/kiosk-sim'),
                  ),
                  const SizedBox(width: 8),
                  _StageChip(
                    icon: Icons.account_tree_rounded,
                    label: 'Timeline',
                    onTap: () => GoRouter.of(context).push('/timeline'),
                  ),
                  const SizedBox(width: 8),
                  _StageChip(
                    icon: Icons.weekend_rounded,
                    label: 'Lounge',
                    onTap: () => GoRouter.of(context).push('/lounge'),
                  ),
                  const SizedBox(width: 8),
                  _StageChip(
                  ...
                  _StageChip(
                    ...
                    label: 'Travel OS',
                    onTap: () => GoRouter.of(context).push('/travel-os'),
                  ),
                ],
              ),
            ),
