            ...
            children: [
              Expanded(
                child: Os2Dial(
                  ...
                  tone: stage.tone,
                  label: 'CONGESTION',
                  center: Os2Text.monoCap('${stage.queue}%', color: Os2.inkBright, size: 14),
                ),
              ),
              const SizedBox(width: Os2.space3),
              Expanded(
            ...
            children: [
              Expanded(
                child: Os2Dial(
                  ...
                  tone: Os2.servicesTone,
                  label: 'LANE 4 · TT',
                  center: Os2Text.monoCap('42%', color: Os2.inkBright, size: 14),
                ),
              ),
              const SizedBox(width: Os2.space3),
              Expanded(
                child: Os2Dial(
                  ...
                  tone: Os2.travelTone,
                  label: 'B-PIER',
                  center: Os2Text.monoCap('86%', color: Os2.inkBright, size: 14),
                ),
              ),
              const SizedBox(width: Os2.space3),
              Expanded(
                child: Os2Dial(
                  ...
                  tone: Os2.walletTone,
                  label: 'LOUNGE',
                  center: Os2Text.monoCap('64%', color: Os2.inkBright, size: 14),
                ),
              ),
            ],
          ),
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        Os2Text.monoCap('\u2192', color: tone, size: 13),
      ],
    );
  }
}
