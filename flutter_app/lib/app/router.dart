...
import '../features/lab/passport_ceremony_screen.dart';
...
import '../cinematic/cinema2/favorite_lockin_ceremony.dart';
import '../cinematic/cinema2/concierge_handoff_ceremony.dart';
import '../cinematic/cinema2/cinema2_hub_screen.dart';
import '../cinematic/cinema3/investment_milestone_ceremony.dart';
...
final routerProvider = Provider<GoRouter>((ref) {
  return GoRouter(
    ...
    routes: [
      ...
      _blurFadeRoute(
        '/ambient/widgets',
        (_, __) => const HomeWidgetGalleryScreen(),
      ),
      _blurFadeRoute(
        '/ambient/watch',
      ...
      _blurFadeRoute(
        '/lab/visa-adapter',
        (_, __) => const VisaAdapterScreen(),
      ),
      _blurFadeRoute(
        '/lab/telemetry',
        (_, __) => const TelemetrySinkScreen(),
      ),
      _blurFadeRoute(
        '/lab/offline-cache',
      ...
      _blurFadeRoute(
        '/lab/passport-ceremony',
        (_, __) => const PassportCeremonyScreen(),
      ),
      _blurFadeRoute(
        '/lab/visa-stamp',
        (_, __) => const VisaStampScreen(),
      ),
      _blurFadeRoute(
        '/lab/boarding-printed',
        (_, __) => const BoardingPrintedScreen(),
      ),
      _blurFadeRoute(
        '/lab/declassified',
      ...
      _blurFadeRoute(
        '/cinematics',
        (_, __) => const CinematicsHubScreen(),
      ),
      _blurFadeRoute(
        '/lab/seal-coldmount',
      ...
      _blurFadeRoute(
        '/lab/receipts',
        (_, __) => const ReceiptsScreen(),
      ),
      _blurFadeRoute(
        '/lab/brand-gallery',
        (_, __) => const BrandSurfaceGalleryScreen(),
      ),
      _blurFadeRoute(
        '/lab/locale-gallery',
      ...
      _blurFadeRoute(
        ...
        (_, __) => const FavoriteLockInCeremonyScreen(),
      ),
      _blurFadeRoute(
        '/ceremony/concierge-handoff',
        (_, __) => const ConciergeHandoffCeremonyScreen(),
      ),
      _blurFadeRoute(
        '/cinema2',
        (_, __) => const Cinema2HubScreen(),
      ),
      _blurFadeRoute(
        '/ceremony/investment-milestone',
        (_, __) => const InvestmentMilestoneCeremonyScreen(),
      ),
